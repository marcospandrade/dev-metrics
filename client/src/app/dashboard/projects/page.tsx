                ...
                <div>
                    {(selectedProjectId && selectedProject) ? (
                        <Tabs value={activeTab}>
                            <TabsHeader
                                className="rounded-none border-b border-gray-200 mx-4 p-0"
                                indicatorProps={{
                                    className:
                            ...
                            <TabsBody>
                                <TabPanel value={ProjectPageTabsEnum.INFO}>
                                    <ProjectInfo selectedProject={selectedProject}></ProjectInfo>
                                </TabPanel>
                                <TabPanel value={ProjectPageTabsEnum.ISSUES}>
                        ...
                        <div className="bg-gray-100 flex text-center justify-center py-8 px-12 rounded">
                            <Typography variant="paragraph" className="text-indigo-500"> You should select a project to view details and issues</Typography>
                        </div>}
                </div>
            </div>
        </div>
