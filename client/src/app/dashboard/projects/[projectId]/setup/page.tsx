...
import {
  ...
  RelevantCustomFieldMap,
} from '../../constants/relevant-custom-fields';
import { ThirdStep } from './steps/ThirdStep';
import { AtlassianCustomField } from '@/services/projects/dto/get-all-custom-fields.dto';
import projectsService from '@/services/projects/projects.service';
import {
  FieldToRegisterDto,
  RegisterCustomFieldsDto,
} from '@/services/projects/dto/register-custom-fields.dto';
...
export default function SetupProject() {
  ...
  const [relevantCustomFields, setRelevantCustomFields] =
    useState<RelevantCustomFieldMap>(RELEVANT_CUSTOM_FIELDS);
  ...
  return (
    <div className="flex min-h-min flex-col justify-between ">
      ...
      <div className="mt-8 flex px-16">
        {activeStep === 0 && <FirstStep />}
        {activeStep === 1 && (
          <SecondStep
            selectedProjectId={projectId}
            handleSetRelevantCustomFields={handleSetRelevantCustomFields}
            relevantCustomFields={relevantCustomFields}
          />
        )}
        {activeStep === 2 && <ThirdStep relevantCustomFields={relevantCustomFields} />}
      </div>

      <div className="mt-8 flex flex-row justify-between px-16">
