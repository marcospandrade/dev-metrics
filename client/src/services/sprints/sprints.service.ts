...
async function startGenerateEstimates(sprintId: string) {
  try {
    const { data } = await api.post<GenericHttpResponse<void>>(`/sprints/generate-estimates`, { sprintId })
