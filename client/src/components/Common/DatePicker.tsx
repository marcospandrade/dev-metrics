  ...
  return (
    <div className="flex flex-1">
      <Popover placement="bottom">
        <PopoverHandler>
          <Input label={label} onChange={() => null} value={value ? format(value, 'PPP', { locale: ptBR }) : ''} />
        </PopoverHandler>
        <PopoverContent>
          <DayPicker
            mode="single"
...
// components={{
//     IconLeft: ({ ...props }) => <LibIcons.ArrowBackIcon {...props} className="h-4 w-4 stroke-2" />,
//     IconRight: ({ ...props }) => <LibIcons.ArrowForwardIcon {...props} className="h-4 w-4 stroke-2" />,
//   }}
